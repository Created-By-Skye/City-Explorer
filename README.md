# code301-Node-Express-Web-Service
## code301-lab07

Building web services with Node.js/Express
### Canvas Link: https://canvas.instructure.com/courses/3385226/assignments/24630351?module_item_id=52730576

You can copy your React client code from lab 6 BUT do not copy the following:
* node_modules directory
* `.git` file from root directory of your lab 06 react client (file may be hidden)

*** Work with your teams as much as possible ***
